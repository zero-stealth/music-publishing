...
const phoneNumber = ref("+255685977148");
        ...
        <div class="contact-holder">
          ...
          <form @submit.prevent="sendMsg" class="contact-f">
            <div class="input-wrapper">
              <input type="text" placeholder="Penguin lee" class="contact-input" v-model="username" required>
              <input type="email" placeholder="Penguinlee@gmail.com" class="contact-input" v-model="email" required>
            </div>
